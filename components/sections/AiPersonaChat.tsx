...
function answerFromKnowledgeBase(input: string): string {
  ...
  if (q.includes('expertise') || q.includes('skills') || q.includes('think')) {
    return `Core thinking frameworks: ${expertiseAreas.map((item) => item.title).join(', ')}.`;
  }
  ...
  return "I can help with Anveet's case studies, projects, how he thinks about building products, and contact details. Ask me something specific and I will keep it concise.";
}
...
export function AiPersonaChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      text: "Hi, I'm AI Anveet. Ask me about my work, case studies, or how I think about building products."
    }
  ]);
    ...
    <section className="rounded-2xl border border-border bg-card p-5">
      ...
      <form onSubmit={onSubmit} className="mt-4 flex gap-2">
        <input
          ...
          placeholder="Ask about case studies, projects, or how I think..."
        />
