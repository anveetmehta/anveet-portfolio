...
export function SystemsLayerSection({ data = systemsLayerContent }: SystemsLayerSectionProps) {
  return (
    <section id="systems-layer" className="relative overflow-hidden border-b border-border py-24 sm:py-32">
        ...
        <div className="grid gap-16 lg:grid-cols-[3fr_2fr] lg:gap-24">
          ...
          <div>
            ...
            <motion.blockquote
              ...
              className="mt-10 border-l-2 border-accent/40 pl-5 text-base font-medium italic text-ink"
            >
              {data.closing}
            </motion.blockquote>
          </div>
            ...
            >
              {data.systemTypes.map((item, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 rounded-lg border border-border bg-card/40 px-4 py-3 text-sm text-ink-2 transition-colors hover:border-foreground/25 hover:text-ink"
                >
